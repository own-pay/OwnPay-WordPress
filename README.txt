...
OwnPay-WordPress adds a simple, secure, and modern payment solution for your online store, allowing customers to pay via card, bank transfer, and mobile banking.

== Description ==

OwnPay WordPress is the official WooCommerce integration for OwnPay payment gateways. It provides your customers with a secure, responsive, and seamless checkout experience. Offer credit/debit cards, bank transfers, and local mobile banking under your own custom white-labeled brand.
...
= 1.0.0 =
* Initial release of the OwnPay WordPress plugin.